...
const SearchBar: Component<SearchBarProps> = ({name: string, onFilter}) => {
    ...
    return (
        <div class="searchbar">
            ...
            <input id="search-input" oninput={onChange} class="search-input" type="text" placeholder={`Filter ${name}...`} />
        </div>
    );
}
