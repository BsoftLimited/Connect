...
const TopBar: Component<TopBarProps> = (props) =>{
    const { sessionState, toggleTheme } = useUserContext();
    const { status, showSettings } = useContextMenuContext();

    return (
        <div class={`topbar` + (props.transparent ? " topbar-tranparent" : "")}>
            <div class="topbar-header">
                <svg class="topbar-icon" xmlns="http://www.w3.org/2000/svg" width={36} height={36} viewBox="0 0 36 36"><path fill="#67757f" d="M35 20c0 2.209-1.791 2-4 2H5c-2.209 0-4 .209-4-2L3 8c.125-1.917 1.791-4 4-4h22c2.209 0 3.791 2.208 4 4z"></path><path fill="#ccd6dd" d="M28 13a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2z"></path><path fill="#e1e8ed" d="M30 17a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2z"></path><path fill="#f5f8fa" d="M32 21a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h24a2 2 0 0 1 2 2z"></path><path fill="#9aaab4" d="M35 31a4 4 0 0 1-4 4H5a4 4 0 0 1-4-4V20a4 4 0 0 1 4-4h26a4 4 0 0 1 4 4z"></path><path fill="#fcab40" d="M22 1h-5a2 2 0 0 0-2 2v1h4a2 2 0 0 1 2 2h1a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2"></path><path fill="#5dadec" d="M18 5h-5a2 2 0 0 0-2 2v1h4a2 2 0 0 1 2 2h1a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2"></path><path fill="#e75a70" d="M16 12a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-1a2 2 0 0 1 2-2h5a2 2 0 0 1 2 2z"></path><path fill="#67757f" d="M25 28a2 2 0 0 1-2 2H13a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2zm-11-4"></path><path fill="#e1e8ed" d="M23 27a1 1 0 0 1-1 1h-8a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1z"></path></svg>
                <h2 class="topbar-title">Connect</h2>
            </div>
            <div style={{ display: "flex", "flex-direction": "row", "align-items": "center", gap: "12px", padding: "0.6rem" }}>
                <Show when={sessionState().data?.user}>
                    <div class={"clicakble"} style={{ display: "flex", "flex-direction": "row", gap: "0rem", "align-items": "center" }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width={"2.2rem"} height={"2.2rem"} viewBox="0 0 48 48"><g fill="currentColor" fill-rule="evenodd" clip-rule="evenodd"><path d="M24 27a8 8 0 1 0 0-16a8 8 0 0 0 0 16m0-2a6 6 0 1 0 0-12a6 6 0 0 0 0 12"/><path d="M44 24c0 11.046-8.954 20-20 20S4 35.046 4 24S12.954 4 24 4s20 8.954 20 20M33.63 39.21A17.9 17.9 0 0 1 24 42a17.9 17.9 0 0 1-9.831-2.92q-.36-.45-.73-.93A2.14 2.14 0 0 1 13 36.845c0-1.077.774-1.98 1.809-2.131c6.845-1 11.558-.914 18.412.035A2.08 2.08 0 0 1 35 36.818c0 .48-.165.946-.463 1.31q-.461.561-.907 1.082m3.355-2.744c-.16-1.872-1.581-3.434-3.49-3.698c-7.016-.971-11.92-1.064-18.975-.033c-1.92.28-3.335 1.856-3.503 3.733A17.94 17.94 0 0 1 6 24c0-9.941 8.059-18 18-18s18 8.059 18 18a17.94 17.94 0 0 1-5.015 12.466"/></g></svg>
