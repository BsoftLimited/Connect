...
const Profile = () =>{
    ...
    return (
        <div style={{ width: "100%" }}>
            <h1 style={{ "padding": "1rem 2rem", "font-weight": "300" }}>Profile</h1>
            <div class={"profile-container"}>
                <svg xmlns="http://www.w3.org/2000/svg" width="8.5rem" height="8.5rem" viewBox="0 0 24 24">
                ...
                <div class={"profile-details-container"}>
                    ...
                    <hr />
                    <ProfileDetail label={"Email"} value={sessionState().data?.user.email}>
                    ...
                    <ProfileDetail label={"Username"} value={ sessionState().data?.user.username }>
                    ...
                    <ProfileDetail label={"Role"} value={ sessionState().data?.user.role }>
                    ...
                    <ProfileDetail label={"Access level"} value={ formatAccessLevel(sessionState().data?.user) }>
                        <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 24 24">
