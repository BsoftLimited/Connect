/*
  ...
  - You are about to drop the column `adminEmail` on the `SiteConfig` table. All the data in the column will be lost.
...
INSERT INTO "new_SiteConfig" ("adminID", "allowQuestDownload", "allowQuestSignup", "createdAt", "id", "maintenanceMessage", "maintenanceMode", "siteDescription", "siteFavicon", "siteLogo", "siteName", "siteUrl", "updatedAt") SELECT "adminID", "allowQuestDownload", "allowQuestSignup", "createdAt", "id", "maintenanceMessage", "maintenanceMode", "siteDescription", "siteFavicon", "siteLogo", "siteName", "siteUrl", "updatedAt" FROM "SiteConfig";
